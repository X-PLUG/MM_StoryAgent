...
setup(
    name='mm-story-agent',  # Replace 'your_package_name' with the name of your package
    version='0.0.1',  # Replace with the desired version number
    # description=
    ...
    # url='https://github.com/modelscope/modelscope-agent',  # Replace with your repository URL
